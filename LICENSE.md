...
Copyright © 2026 Sébastien Roche — <https://sebastien-roche.fr/>

Taffk est distribué sous la **PolyForm Noncommercial License 1.0.0**.

## En clair (résumé non contractuel)

Vous êtes libre de :

- **utiliser** Taffk autant que vous le souhaitez ;
- **étudier** et **modifier** le code source ;
- **partager** l'application et vos versions modifiées (forks) ;
- **contribuer** au projet.

À **une seule condition** : **uniquement à des fins non commerciales**.
Toute exploitation visant à **gagner de l'argent** avec Taffk ou avec un
quelconque dérivé/fork — vente, abonnement payant, service commercial, intégration
dans un produit payant — est **interdite sans l'autorisation écrite de l'auteur**.

Les usages personnels, éducatifs, associatifs, de recherche et par des
organisations à but non lucratif sont expressément autorisés. En cas de doute,
le texte formel ci-dessous fait foi.

> Required Notice: Copyright © 2026 Sébastien Roche (https://sebastien-roche.fr/)
